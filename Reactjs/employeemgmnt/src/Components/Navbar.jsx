  ...
  return (
    <div>
      <nav class="relative bg-gray-800">
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div class="relative flex h-16 items-center justify-between">
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              {/* <button type="button" command="--toggle" commandfor="mobile-menu" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-white/5 hover:text-white focus:outline-2 focus:-outline-offset-1 focus:outline-indigo-500" onClick={menuopenclose}>
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4">
                  ...
                  <NavLink to={'/'} className="rounded-md  px-3 py-2 text-sm font-medium text-white">Dashboard</NavLink>
                  <NavLink to={'/employee'} className="rounded-md  px-3 py-2 text-sm font-medium text-white">Employee</NavLink>
                  <NavLink to={'/counter'} className="block rounded-md hover:bg-white/5 hover:text-white px-3 py-2 text-base font-medium text-white">Counter App</NavLink>
        ...
        {/* <el-disclosure id="mobile-menu" className={`${isOpen ? 'block' : 'hidden'} sm:hidden`}>
          <div class="space-y-1 px-2 pt-2 pb-3">
            <NavLink to={'/'} className="block rounded-md hover:bg-white/5 hover:text-white px-3 py-2 text-base font-medium text-white">Dashboard</NavLink>
            <NavLink to={'/employee'} className="block rounded-md hover:bg-white/5 hover:text-white px-3 py-2 text-base font-medium text-white">Employee</NavLink>
